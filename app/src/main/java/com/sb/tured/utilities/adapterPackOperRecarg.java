...
public class adapterPackOperRecarg extends RecyclerView.Adapter<adapterPackOperRecarg.ViewHolderList>
        implements View.OnClickListener{

    public ArrayList<PackOperRecarga> listPackOperRecarg;
    public View.OnClickListener listener;


    public adapterPackOperRecarg(ArrayList<PackOperRecarga> listPackOperRecarg) {
        this.listPackOperRecarg = listPackOperRecarg;
    }
    ...
    public void onBindViewHolder(final ViewHolderList holder, final int position) {
        holder.etiNombre.setText(listPackOperRecarg.get(position).getDescripcion());
        //holder.etiInformacion.setText("Valor:"+listPackOperRecarg.get(position).getValor());
        /*Picasso.get()
    ...
    public int getItemCount() {
        return listPackOperRecarg.size();
    }
    ...
    public class ViewHolderList extends RecyclerView.ViewHolder {
        ...
        public ViewHolderList(View itemView) {
            ...
            etiInformacion= itemView.findViewById(R.id.tvInformacion);
